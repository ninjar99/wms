...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		btnQuery.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				strWheres = QueryDialog.queryValueResult;
				if(strWheres.length()>0){
					strWheres = " and "+strWheres;
				}
...
//				getHeaderTableData("");
	...
	private void getInvTableData(String retWhere){
		String sql = "select @rowno:=@rowno+1 as 序号,ii.WAREHOUSE_CODE 仓库编码,bw.WAREHOUSE_NAME 仓库名称,ii.STORER_CODE 货主编码,bs.STORER_NAME 货主名称,ii.LOCATION_CODE 库位编码,"
				...
				+"left join bas_location bl on ii.LOCATION_CODE=bl.LOCATION_CODE and ii.WAREHOUSE_CODE=bl.WAREHOUSE_CODE "
